...
Our first aim in this project was to see if Democratic and Republican Members of Congress used the same words frequently. Secondly, we wanted to see when and why some of these words were frequently used. Lastly, we wanted to know which of the most frequent words leads to increased user engagement. 
...
Through the visualizations presented in this section, we have illustrated that the ideologies of each party are expressed through legislators' word choice, and shown insight into the strategic side of politicians' tweets. Politicians seem to adopt the method of attacking the opposition on Twitter to increase engagement, such as retweets, and reach more users to spread their ideas and gain support.
...
Overall, our data illustrate that within political parties, Members of Congress frequently use words that align with their respective parties' political agendas. However, when they do deviate away from this, it is to criticize the other political party. We found that Democrats often tweet the word "Trump", while Republicans tweet "Biden". This happens most during moments where the Democrats can criticize Republican leadership and vice versa and is a tactic to gain more support from constituents. For example, during June 2022, when the word "Trump" was frequently used by Democrats, Democratic Members of Congress were tweeting about Trump and the January 6th insurrection to deter voters from electing GOP candidates. This tactic seems to work if you look at the engagement data we collected. Tweets that include words like "Trump" have higher engagement levels. If we were to continue our investigation, we would be interested to investigate the relationship between the nature of Twitter and the nature of its users (e.g. US politicians, as in this case), in terms of which influences the other more strongly (like the chicken or the egg question) or whether it is a mutual influence. Additionally, we would also examine the distinctions, if any, between what politicians tweet out versus what they say in Congress itself.
